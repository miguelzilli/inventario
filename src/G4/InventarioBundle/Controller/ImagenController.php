...
use G4\InventarioBundle\Form\ImagenType;
use G4\InventarioBundle\Form\ImagenFilterType;
...
class ImagenController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('G4InventarioBundle:Imagen:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('G4InventarioBundle:Imagen')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('G4InventarioBundle:Imagen')->find($id);
        ...
        return $this->render('G4InventarioBundle:Imagen:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('G4InventarioBundle:Imagen:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('G4InventarioBundle:Imagen:edit.html.twig', array(
            'entity'      => $entity,
