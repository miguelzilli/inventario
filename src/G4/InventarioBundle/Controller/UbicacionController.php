...
use G4\InventarioBundle\Form\UbicacionType;
use G4\InventarioBundle\Form\UbicacionFilterType;
...
class UbicacionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('G4InventarioBundle:Ubicacion:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('G4InventarioBundle:Ubicacion')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('G4InventarioBundle:Ubicacion')->find($id);
        ...
        return $this->render('G4InventarioBundle:Ubicacion:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('G4InventarioBundle:Ubicacion:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('G4InventarioBundle:Ubicacion:edit.html.twig', array(
            'entity'      => $entity,
