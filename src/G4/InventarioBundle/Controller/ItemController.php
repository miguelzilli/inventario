...
use G4\InventarioBundle\Form\ItemType;
use G4\InventarioBundle\Form\ItemFilterType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('G4InventarioBundle:Item:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('G4InventarioBundle:Item')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('G4InventarioBundle:Item')->find($id);
        ...
        return $this->render('G4InventarioBundle:Item:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('G4InventarioBundle:Item:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('G4InventarioBundle:Item:edit.html.twig', array(
            'entity'      => $entity,
