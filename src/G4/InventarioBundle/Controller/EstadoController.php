...
use G4\InventarioBundle\Entity\Estado;
use G4\InventarioBundle\Form\EstadoType;
use G4\InventarioBundle\Form\EstadoFilterType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('G4InventarioBundle:Estado:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('G4InventarioBundle:Estado')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('G4InventarioBundle:Estado')->find($id);
        ...
        return $this->render('G4InventarioBundle:Estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('G4InventarioBundle:Estado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('G4InventarioBundle:Estado:edit.html.twig', array(
            'entity'      => $entity,
