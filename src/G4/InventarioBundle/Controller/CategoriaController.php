...
use G4\InventarioBundle\Form\CategoriaType;
use G4\InventarioBundle\Form\CategoriaFilterType;
...
class CategoriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('G4InventarioBundle:Categoria:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('G4InventarioBundle:Categoria')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('G4InventarioBundle:Categoria')->find($id);
        ...
        return $this->render('G4InventarioBundle:Categoria:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('G4InventarioBundle:Categoria:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('G4InventarioBundle:Categoria:edit.html.twig', array(
            'entity'      => $entity,
